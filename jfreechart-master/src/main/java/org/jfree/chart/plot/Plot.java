...
public abstract class Plot implements ChartElement, AxisChangeListener,
    ...
    private transient PlotProduct3 plotProduct3 = new PlotProduct3();

	private PlotProduct2 plotProduct2 = new PlotProduct2();
    ...
    protected Plot() {
        ...
        plotProduct2.setBackgroundImage2(null);
        ...
        this.notify = true;
        plotProduct3.getPlotProduct().setListenerList(new EventListenerList());
    }
    ...
    public Image getBackgroundImage() {
        return this.plotProduct2.getBackgroundImage();
    }
    ...
    public void setBackgroundImage(Image image) {
        plotProduct2.setBackgroundImage(image, this);
    }
    ...
    public RectangleAlignment getBackgroundImageAlignment() {
        return this.plotProduct2.getBackgroundImageAlignment();
    }
    ...
    public void setBackgroundImageAlignment(RectangleAlignment alignment) {
        plotProduct2.setBackgroundImageAlignment(alignment, this);
    }
    ...
    public float getBackgroundImageAlpha() {
        return this.plotProduct2.getBackgroundImageAlpha();
    }
    ...
    public void setBackgroundImageAlpha(float alpha) {
        plotProduct2.setBackgroundImageAlpha(alpha, this);
    }
    ...
    public void setNotify(boolean notify) {
        plotProduct3.setNotify(notify, this);
    }
    ...
    public void addChangeListener(PlotChangeListener listener) {
        plotProduct3.getPlotProduct().addChangeListener(listener);
    }
    ...
    public void removeChangeListener(PlotChangeListener listener) {
        plotProduct3.getPlotProduct().removeChangeListener(listener);
    }
    ...
    public void notifyListeners(PlotChangeEvent event) {
        plotProduct3.notifyListeners(event, this);
    }
    ...
    protected void fireChangeEvent() {
        plotProduct3.notifyListeners(new PlotChangeEvent(this), this);
    }
    ...
    public void drawBackground(Graphics2D g2, Rectangle2D area) {
        ...
        plotProduct2.drawBackgroundImage(g2, area);
    }
	...
	private Paint p(Rectangle2D area, PlotOrientation orientation) {
		Paint p = this.backgroundPaint;
		if (p instanceof GradientPaint) {
			GradientPaint gp = (GradientPaint) p;
			if (orientation == PlotOrientation.VERTICAL) {
				p = new GradientPaint((float) area.getCenterX(), (float) area.getMaxY(), gp.getColor1(),
						(float) area.getCenterX(), (float) area.getMinY(), gp.getColor2());
			} else if (orientation == PlotOrientation.HORIZONTAL) {
				p = new GradientPaint((float) area.getMinX(), (float) area.getCenterY(), gp.getColor1(),
						(float) area.getMaxX(), (float) area.getCenterY(), gp.getColor2());
			}
		}
		return p;
	}
    ...
    public void datasetChanged(DatasetChangeEvent event) {
        ...
        plotProduct3.notifyListeners(newEvent, this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.equals(this.plotProduct2.getBackgroundImage(), that.plotProduct2.getBackgroundImage())) {
            return false;
        }
        if (this.plotProduct2.getBackgroundImageAlignment() != that.plotProduct2.getBackgroundImageAlignment()) {
            return false;
        }
        if (this.plotProduct2.getBackgroundImageAlpha() != that.plotProduct2.getBackgroundImageAlpha()) {
            return false;
        }
    ...
    public Object clone() throws CloneNotSupportedException {
		...
		clone.plotProduct3 = (PlotProduct3) this.plotProduct3.clone();
		clone.plotProduct2 = (PlotProduct2) this.plotProduct2.clone();
		clone.plotProduct3.setPlotProduct((PlotProduct) this.plotProduct3.getPlotProduct().clone());
        ...
        clone.plotProduct3.getPlotProduct().setListenerList(new EventListenerList());
        return clone;
    }
    ...
    private void writeObject(ObjectOutputStream stream) throws IOException {
		...
		stream.writeObject(this.plotProduct3);
		stream.writeObject(this.plotProduct3.getPlotProduct());
	...
	private void stream(ObjectInputStream stream) throws IOException, ClassNotFoundException {
		...
		this.plotProduct3 = (PlotProduct3) stream.readObject();
		plotProduct3.setPlotProduct((PlotProduct) stream.readObject());
